...
> ## Сборка YouTube RVX прекращена
>
> В связи с выходом патчей **RVX 4.3.0-dev2** в само приложение была добавлена возможность **кастомизации**, поэтому отдельная сборка YouTube RVX в рамках данного проекта больше не требуется.
